<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminGuncelle.aspx.cs" Inherits="YazOkuluProje.AdminGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="w-50 mx-auto mt-4">
        <div class="form-group">
            <strong>
                <asp:Label for="txtId" runat="server" Text="Admin ID:"></asp:Label>
            </strong>
